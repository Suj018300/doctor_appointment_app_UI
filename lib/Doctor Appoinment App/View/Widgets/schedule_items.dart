        ...
        children: [
          ...
          Row(
            children: [
              Row(
                children: [
                  const Icon(Icons.calendar_month, color: grey),
                  const SizedBox(width: 5),
                  Text(
                    DateFormat("d/MM/y").format(schedule.time),
                    style: const TextStyle(color: black, letterSpacing: -.5),
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  const Icon(Icons.access_time_filled, color: grey),
                  const SizedBox(width: 5),
                  Text(
                    DateFormat("jm").format(schedule.time),
                    style: const TextStyle(color: black, letterSpacing: 0),
                  ),
                ],
              ),
              const SizedBox(width: 25),
